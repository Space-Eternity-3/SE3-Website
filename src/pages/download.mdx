...
:::tip
Windows is the best system to download SE3, but Linux and MacOS are supported too.
:::

:::note
Launcher is only available on computers with Windows or Linux. If you use MacOS
or encounter any problems during installation, see [direct downloads](#direct-downloads).
:::
